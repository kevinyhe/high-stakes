...
void blue_mogo()
{
    ...
    // mogo rush
    chassis->moveToPoint(23, -36.5, 2000, {.minSpeed = 127, .earlyExitRange = 8});
    chassis->moveToPoint(13.5, -37.5, 3000, {.minSpeed = 50, .earlyExitRange = 4});
    ...
    chassis->moveToPoint(16.5, -42, 3000, {.forwards = false, .maxSpeed = 70});
    ...
    chassis->moveToPose(8.509, -8.57, -30, 2000);
    chassis->waitUntilDone();
    doinker.extend();
    pros::delay(200);
    ...
    intake.set_state(mechanism::IntakeState::HOOK);
    pros::delay(1000);
    chassis->moveToPose(33, -33, 30, 3000);
